        ...
        {{--  <div class="col-md-4  ">
            <div class="card ">
                ...
                <div class="d-flex justify-content-between px-5">
                    ...
                    <div class="">
                        <p class="pt-3">daily_rent_price</p>
                    </div>
                </div>
                <div class="d-flex justify-content-between px-5">
                    <a href="" type="button"
                        class="btn details-id bg-success py-2 mr-1 rounded-pill shadow">Rent Now</a>
                    <a href="#" data-id="${item['id']}" type="button"
                        class="btn details-id bg-primary py-2 mr-1 rounded-pill shadow">Details</a>
                </div>
            ...
            <div class="card ">
                ...
                <div class="d-flex justify-content-between px-5">
                    <a href="" type="button" data-id="${item['id']}"
                        class="btn Rent-id bg-success py-2 mr-1 rounded-pill shadow">Rent Now</a>
                    <a href="#" data-id="${item['id']}" type="button"
                        class="btn details-id bg-primary py-2 mr-1 rounded-pill shadow">Details</a>
                </div>
